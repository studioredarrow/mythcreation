...
export default class Button extends Component {
  constructor ({element, template}) {
    ...
    //   strokeDasharray: `${this.pathLength} ${this.pathLength}`,
    // })
    GSAP.set(this.path, {strokeDasharray:this.pathLength})
    this.timeline.fromTo(this.path, 100, {strokeDashoffset:this.pathLength}, {strokeDashoffset:100})
  ...
  onMouseEnter () {
    ...
    //   GSAP.fromTo(this.path, 100, {strokeDashoffset:this.pathLength}, {strokeDashoffset:100})
    // )
